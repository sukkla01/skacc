        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <div class="pull-left"><span style="font-weight: bold;" class="btn btn-info btn-flat"><h4><i class="fa fa-bookmark"></i>&nbsp;&nbsp;จำนวนการเจ็บ จำแนกตามประเภทการเกิดอุบัติเหตุ</h4></span></div>
                    <div  class="pull-right">
                        <div>
                            ...
                            <div class="btn-group pull-right" role="group">
                                <a style="font-weight: bold;" class="<?=$b1?>" href="<?= Url::to(['kpireport/vinjury', 'rep_year' => '2016']) ?>">2559</a>
                                <a style="font-weight: bold;" class="<?=$b2?>" href="<?= Url::to(['kpireport/vinjury', 'rep_year' => '2017']) ?>">2560</a>
                                <a style="font-weight: bold;" class="<?=$b3?>" href="<?= Url::to(['kpireport/vinjury', 'rep_year' => '2018']) ?>">2561</a>
                            </div>
                            <div class="pull-right">
